...
ALERT_TOPICS = [
    "topic/leak",  # Add more topics as needed to this list. the topics should be 0 for no fault and 1 for fault. they also needs to be added to the grafana server dashboard status panel vis. 
]
